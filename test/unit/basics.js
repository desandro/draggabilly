QUnit.test( 'init', function( assert ) {
  ...
  draggie.once( 'pointerDown', function( event, pointer ) {
    ...
    assert.ok( draggieElem.classList.contains('is-pointer-down'), 'is-pointer-down class added' );
  });
  ...
  draggie.once( 'dragStart', function( event, pointer ) {
    ...
    assert.ok( draggieElem.classList.contains('is-dragging'), 'is-dragging class added' );
  });
  ...
  draggie.once( 'dragEnd', function( event, pointer ) {
    ...
    assert.ok( !draggieElem.classList.contains('is-dragging'), 'is-dragging class removed' );
